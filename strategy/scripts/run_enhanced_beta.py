#!/usr/bin/env python3
"""
Script for running the Enhanced Beta strategy backtest using the new models infrastructure.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Run Enhanced Beta strategy backtest with the new models framework"
    )
...
def main():
    """Main function to run the Enhanced Beta strategy backtest."""
    # Parse arguments
    args = parse_arguments()

    print(
        f"Running Enhanced Beta strategy backtest from {args.start_date or 'earliest available'} to {args.end_date or 'latest available'}"
    )
    ...
    # Initialize Enhanced Beta strategy
    print("Initializing Enhanced Beta strategy...")
    ...
    result_path = f"{args.output_dir}/enhanced_beta_results_{timestamp}.json"
