...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Run Beta strategy backtest with the new models framework"
    )
...
def main():
    """Main function to run the Beta strategy backtest."""
    # Parse arguments
    args = parse_arguments()

    print(
        f"Running Beta strategy backtest from {args.start_date or 'earliest available'} to {args.end_date or 'latest available'}"
    )
    ...
    # Initialize Beta strategy
    print("Initializing Beta strategy...")
    ...
    # Detect if data is daily, 8h, etc.
